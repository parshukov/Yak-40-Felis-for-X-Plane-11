...
--------------------------------------------------------------------------------------------------------------------
defineProperty("tas", globalPropertyf("sim/flightmodel/position/true_airspeed")) -- tas variable meters per second-- истинная скорость из dataref
--------------------------------------------------------------------------------------------------------------------
...
if passed > 0 then
	...
	if power then
		...
		spd_warn = speed > 455 and real_alt < 6000 or speed_tas > 605 and real_alt > 6000 or speed > 305 and flaps > 20
				or speed > 255 and flaps > 34 or speed > 325 and gears > 0.3 or test_lamp
		-- добавлено условие по истинной скорости
