...
defineProperty("background_lit", loadImage("achs1_lit.png", 0, 0, 200, 200))
...
defineProperty("time_sec_nd", loadImage("achs1.png", 213, 10, 14, 160))
defineProperty("flight_hour_nd", loadImage("achs1.png", 25, 210, 7, 72))
defineProperty("flight_min_nd", loadImage("achs1.png", 39, 210, 7, 72))
...
defineProperty("time_sec_nd_lit", loadImage("achs1_lit.png", 213, 10, 14, 160))
defineProperty("flight_hour_nd_lit", loadImage("achs1_lit.png", 25, 210, 7, 72))
defineProperty("flight_min_nd_lit", loadImage("achs1_lit.png", 39, 210, 7, 72))
...
-- lit
defineProperty("flag_0_lit", loadImage("achs1_lit.png", 7, 221, 8, 6))  -- white
defineProperty("flag_1_lit", loadImage("achs1_lit.png", 7, 238, 8, 6))  -- red
defineProperty("flag_2_lit", loadImage("achs1_lit.png", 7, 230, 8, 6))  -- red/white
