-- this is cockpit ventilators angle calculations

-- define property table

defineProperty("vent_1", globalPropertyf("sim/custom/xap/misc/vent_1"))
defineProperty("vent_2", globalPropertyf("sim/custom/xap/misc/vent_2"))
defineProperty("vent_3", globalPropertyf("sim/custom/xap/misc/vent_3"))
defineProperty("vent_4", globalPropertyf("sim/custom/xap/misc/vent_4"))

defineProperty("vent_1_sw", globalPropertyi("sim/custom/xap/misc/vent_1_sw"))
defineProperty("vent_2_sw", globalPropertyi("sim/custom/xap/misc/vent_2_sw"))
defineProperty("vent_3_sw", globalPropertyi("sim/custom/xap/misc/vent_3_sw"))
defineProperty("vent_4_sw", globalPropertyi("sim/custom/xap/misc/vent_4_sw"))

defineProperty("DC_27_volt", globalPropertyf("sim/custom/xap/power/DC_27_volt")) -- 27 volt

defineProperty("frame_time", globalPropertyf("sim/custom/xap/time/frame_time")) -- flight time
...
function update()
	...
	-- vent 4
	if power and get(vent_4_sw) == 1 then vent4_spd = vent4_spd + UP_SPD * passed
