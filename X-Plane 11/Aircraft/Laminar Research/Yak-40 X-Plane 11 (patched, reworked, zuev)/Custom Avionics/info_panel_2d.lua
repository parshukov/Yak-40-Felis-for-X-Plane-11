...
defineProperty("info_subpanel", globalPropertyi("sim/custom/xap/panels/info_subpanel"))

-- images
defineProperty("background", loadImage("info_panel.png", 0, 0, size[1], size[2]))
defineProperty("digitsImage", loadImage("black_digit_strip.png", 1, 0, 14, 196))
defineProperty("from_img", loadImage("info_panel.png", 227, 0, 29, 12))
defineProperty("to_img", loadImage("info_panel.png", 227, 12, 29, 12))
defineProperty("none_img", loadImage("info_panel.png", 228, 15, 1, 1))
