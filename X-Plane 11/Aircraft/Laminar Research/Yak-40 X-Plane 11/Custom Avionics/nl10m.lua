...
defineProperty("nl10m_subpanel", globalPropertyi("sim/custom/xap/panels/nl10"))

-- add map textures
defineProperty("ruler1", loadImage("nl10m.png", 0, 0, 2048, 300))
defineProperty("ruler2", loadImage("nl10m.png", 0, 296, 2048, 300))

defineProperty("slider1", loadImage("nl10m.png", 0, 638, 2048, 145))
defineProperty("slider2", loadImage("nl10m.png", 0, 806, 2048, 145))

defineProperty("change_side_img", loadImage("nl10m.png", 4, 996, 132, 23))
